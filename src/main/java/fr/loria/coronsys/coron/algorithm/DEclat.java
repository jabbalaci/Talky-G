...
/** 
 * Controller class.
 * dEclat - like Eclat v1, but here we use diffsets
 * 
 * More precisely: at level 1 we use tidsets (direct children of the root),
 * and below (level > 1) we use diffsets.
 *  
...
implements Algorithm
{
    ...
    */
   public DEclat(Vector database, int min_supp)
   {
      DemoCoron.checkAlg(C.ALG_DECLAT);
      //
